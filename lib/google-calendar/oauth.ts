...
// TODO(Sprint 3 #61): build the Google OAuth consent URL
...
export function getAuthUrl(_churchGroupId: string): string {
  throw new Error("getAuthUrl not implemented — see Sprint 3 #61");
}

// TODO(Sprint 3 #61): exchange the OAuth code for tokens
...
export async function exchangeCode(_code: string): Promise<never> {
  throw new Error("exchangeCode not implemented — see Sprint 3 #61");
}
