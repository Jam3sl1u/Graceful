...
**Stage 0 — Setup.**
1. Fetch the oldest open issue: `gh issue list --state open --sort created --order asc --limit 1 --json number,title,body,url`. If there are no open issues, stop and report that to the user — do not proceed.
